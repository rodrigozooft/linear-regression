...
loan_model <- rpart(formula = outcome ~ ., data = loans_train, method = "class", control = rpart.control(cp = 0))
...
loan_model <- randomForest(formula = outcome ~ ., data = loans_train, ntree = 500)
